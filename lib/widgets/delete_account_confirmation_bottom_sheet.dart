      ...
      child: Column(
        ...
        children: [
          ...
          Padding(
            ...
            child: Text(
              'Ця дія є незворотною. Всі ваші дані, оголошення та налаштування будуть видалені назавжди',
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    onPressed: () async {
                      try {
                        // Тут можна додати логіку видалення акаунту
                        // Наприклад, видалення всіх даних користувача з бази
                        ...
                        if (context.mounted) {
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content: Text('Помилка видалення акаунту: $e'),
